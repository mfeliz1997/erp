...
export function ImportModal() {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="sm:max-w-[95vw] lg:max-w-[1200px] h-[90vh] flex flex-col rounded-xl border border-gray-200 p-0 overflow-hidden">
        <div className="p-8 bg-zinc-50 border-b-2 border-zinc-100 flex justify-between items-end flex-shrink-0">
           <div>
             <div className="flex items-center gap-2 text-zinc-400 mb-2">
                <FileSpreadsheet className="w-4 h-4" />
                <span className="text-xs font-bold   leading-none">Catalog Import</span>
             </div>
             <DialogTitle className="text-4xl font-semibold   leading-none">Importación Inteligente</DialogTitle>
           ...
           <div className="hidden md:block bg-primary text-primary-foreground px-4 py-2 text-xs font-semibold  ">
