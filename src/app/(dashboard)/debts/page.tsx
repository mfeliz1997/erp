      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b-4 border-black pb-10">
        <div className="space-y-3">
          <div className="flex items-center gap-3 text-red-500">
            ...
            <span className="text-[10px] font-bold uppercase tracking-[0.3em] leading-none text-zinc-400">Receivables</span>
          </div>
          <h1 className="text-6xl font-black uppercase tracking-tighter leading-none">Cuentas por Cobrar</h1>
        ...
        <div className="bg-red-50 border-2 border-red-200 p-6 rounded-none">
           <p className="text-[10px] font-black uppercase tracking-widest text-red-600 mb-1">Total Por Cobrar</p>
